...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/styleMed.css">
  </head>
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
          ...
          <div class="col-lg-12 d-block">
            <div class="row d-flex">
              <div class="col-md pr-4 d-flex topper align-items-center">
                ...
                <span class="text">+267 6243556</span>
              </div>
              <div class="col-md pr-4 d-flex topper align-items-center">
                <div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
                <span class="text">info@botsogo.co.bw</span>
              </div>
              <div class="col-md-5 pr-4 d-flex topper align-items-center text-lg-right justify-content-end">
                <p class="mb-0 register-link"><a href="#" class="mr-3"></a>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar" style="height: 100px;">
      <div class="container">
        <a class="navbar-brand" href="/home"><img src="images/botsogo_Logo.png" style="width: 100px;height: 100px;" alt="IMG"></a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav nav ml-auto">
            ...
            <li class="nav-item"><a href="/PatientInsights.viewInsights" class="nav-link"><span>Health Insights</span></a></li>
            <li class="nav-item"><a href="/AppointmentResolver.viewScheduledAppointments" class="nav-link"><span>Scheduler</span></a></li>
            <li class="nav-item"><a href="/PatientNotification.view" class="nav-link"><span>Notifications</span></a></li>
            <li class="nav-item"><a href="/PatientPrescription.viewPrescription" class="nav-link"><span>Prescriptions</span></a></li>
           
            <li class="nav-item cta mr-md-2"><a href="/Appointment.create" class="nav-link" >Appointment</a></li>
             <li class="nav-item"><a href="#contact-section" ><span>{{Auth::user()->name}}</span></a></li>
          </ul>
        </div>
      </div>
    </nav>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
            <div class="mt-5">
              <span class="subheading">Welcome to Botsogo</span>
  ...
  <script src="js/mainMed.js"></script>
